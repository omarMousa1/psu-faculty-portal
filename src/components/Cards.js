...
export const Cards = ({ picture, name, position, college }) => {
  return (
    <div className="bg-[#f1f1f1] lg:w-full lg:flex lg:flex-row lg:justify-start lg:items-center lg:h-[170px] lg:p-2 w-[181px] h-[325px] flex flex-col justify-center items-center space-y-2 p-4 md:w-[363px] md:h-[285px] md:justify-center md:items-center cursor-pointer">
